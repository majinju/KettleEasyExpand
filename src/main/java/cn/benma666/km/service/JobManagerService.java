 ...
 * @version 
 */
public class JobManagerService extends BasicObject{
    //作业类型
    ...
    public static final String JOB_TYPE_DXLZ = "dxlz";
    ...
    */
    ...
    //模板信息
    public static final String templateRoot = "default/template/";
    public static final String templateHz = "Template.kjb";

    /**
    * 日志
    */
    public static Log log = LogFactory.getLog(JobManagerService.class);
    ...
    */
    public static JobMeta editJobInfo(Map<String, String[]> paraMap, JsonResult result,String jobType)
    ...
    * @throws KettleXMLException 
    */
    public static JsonResult editJobShell(Map<String, String[]> paraMap) throws Exception {
        //默认成功
        JsonResult result = success("创建成功");
    ...
    * @throws KettleXMLException 
    */
    public static JsonResult editJobJavascript(Map<String, String[]> paraMap) throws Exception {
        //默认成功
        JsonResult result = success("创建成功");
    ...
    * @throws KettleXMLException 
    */
    public static JsonResult editJobSql(Map<String, String[]> paraMap) throws Exception {
        //默认成功
        JsonResult result = success("创建成功");
//        JobMeta jm = editJobInfo(paraMap, result,JOB_TYPE_SQL);
//        String dbCode = paraMap.get("database")[0];
//        SysDatabase db = SysDatabase.dao.queryFast("ocode",dbCode);
//        //自动修正为配置文件中的数据库信息
...
//        KettleUtils.saveJob(jm);
    ...
    * @throws KettleXMLException 
    */
    public static JsonResult editJobKm(Map<String, String[]> paraMap) throws Exception {
        //默认成功
        JsonResult result = success("创建成功");
        JobMeta jm = editJobInfo(paraMap, result,JOB_TYPE_KM);
        
        JobEntryEasyExpand km = (JobEntryEasyExpand) jm.findJobEntry(JOB_TYPE_KM).getEntry();
