...
package cn.benma666.kettleutil.utilrun;
...
import cn.benma666.kettleutil.KettleUtilRunBase;
...
public class KurDemo extends KettleUtilRunBase{
    /**
    * 具体处理每一行数据
    * @see cn.benma666.kettleutil.KettleUtilRunBase#disposeRow(java.lang.Object[])
    */
    @Override
    ...
    /**
    * 
    * @see cn.benma666.kettleutil.KettleUtilRunBase#init()
    */
    @Override
    protected void init() {
        ku.logBasic("初始化插件");
    ...
    /**
    * 
    * @see cn.benma666.kettleutil.KettleUtilRunBase#end()
    */
    @Override
    protected void end() {
        ku.logBasic("数据处理结束");
    ...
    /**
     * 
     * @see cn.benma666.kettleutil.KettleUtilRunBase#getDefaultConfigInfo(org.pentaho.di.trans.TransMeta, java.lang.String)
     */
     @Override
